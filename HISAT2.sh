...
export PATH=${PATH}:/home/juninamo/bin/
...
do
    cd /home/juninamo/GEUV/YRI/fastq/"$file"_combined_HISAT2_GRCh38
    echo "mapping $file"
    hisat2 --summary-file "$file"_rep1_hisat2_GRCh38 --new-summary -x /home/juninamo/reference/genome_index \
